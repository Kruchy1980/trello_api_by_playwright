...
import {
  ...
  prepareRandomBoardLabelData,
  prepareRandomCardLabelData,
} from 'future/7.Refactor_simplifying_factories/part_1_finished/factories/cards_labels-data.factory';
...
test.describe('Cards labels handling - factories implementation', () => {
  ...
  test('1. Should add label to card', async ({ request }) => {
    ...
    // };
    const data: LabelOperationsDataModel =
      prepareOperationData(createdBoardLabelId);
